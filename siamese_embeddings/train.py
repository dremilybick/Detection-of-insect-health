...
contrastive_train = ContrastiveSampler(train_dataset, siamese_model, batch_size=batch_size)
train_loader = DataLoader(train_dataset, batch_sampler=contrastive_train)
contrastive_test = ContrastiveSampler(test_dataset, siamese_model, batch_size=batch_size)
